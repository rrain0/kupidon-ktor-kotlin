package com.rrain.utils.base.url

import com.rrain.utils.mime.mimeToExtOrEmpty
...
fun main() {
  run {
    ...
    println("url.props: ${url.props}")
    println("url.data: ${url.data}")
    println("url.mimeType: ${url.mimeType}")
    println("url.preferredExt: ${url.preferredExt}")
    println("url.isBase64: ${url.isBase64}")
  }
  run {
    // rainbow circle
    val url = DataUrl(
