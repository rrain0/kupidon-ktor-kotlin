...
object LiveInternal {
  ...
  private val updatedUsers: MutableSet<UserId> = concurrentSetOf()
  private val updatedSessions: MutableSet<SessionId> = concurrentSetOf()
  private val updatedSessionToWsSessions: MutableSet<SessionToWsSessionId> = concurrentSetOf()
  private val updatedWsSessions: MutableSet<WsSession> = concurrentSetOf()
  
  fun pushUpdates() {
    // TODO push somewhere...
    updatedUsers.clear()
    updatedSessions.clear()
    updatedSessionToWsSessions.clear()
    updatedWsSessions.clear()
  }
  ...
  val hasChanges get() = (
    ...
    changedSessions.isNotEmpty() ||
    changedSessionToWsSessions.isNotEmpty() ||
    changedWsSessions.isNotEmpty()
  )
